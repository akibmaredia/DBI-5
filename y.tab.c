...
{
       0,   100,   100,   108,   115,   121,   127,   132,   137,   142,
     147,   152,   164,   177,   183,   188,   195,   203,   209,   215,
     222,   229,   237,   247,   260,   270,   276,   285,   296,   301,
     306,   311,   317,   331,   340,   348,   357,   366,   373,   380,
     388,   396,   404,   412,   424,   432,   440
};
#endif
...
static const char *const yytname[] =
{
  ...
  "CREATE", "TABLE", "HEAP", "INSERT", "INTO", "DROP", "SET", "OUTPUT",
  "STDOUT", "NONE", "SELECT", "GROUP", "DISTINCT", "BY", "FROM", "WHERE",
  "SUM", "AS", "AND", "OR", "QUIT", "';'", "'('", "')'", "','", "'-'",
  "'+'", "'*'", "'/'", "'<'", "'>'", "'='", "$accept", "SQL", "AttrList",
...
{
       0,     7,    13,    18,    23,     6,   -37,    30,    35,    34,
      43,     5,   -37,    48,   -11,    31,    22,    24,   -37,    25,
      53,    29,    32,    33,    36,    24,    38,    -1,    55,    48,
      56,    59,    40,   -37,   -37,   -37,   -37,    -1,   -37,   -37,
     -37,    -1,    -1,    39,     1,    41,    -8,    24,   -37,    60,
      42,   -37,    44,    45,   -37,   -37,   -37,   -37,   -37,   -37,
      -1,    63,    47,    67,    46,    49,   -37,     1,   -37,   -37,
      37,     4,    54,    59,    62,    -1,   -37,   -37,   -37,   -37,
      50,    57,    12,    61,   -37,    76,   -37,    58,   -37,    64,
      37,   -37,   -37,   -37,    37,    48,   -37,   -37,    47,   -37,
     -37,    16,   -37,   -37
};
...
static const yytype_uint8 yydefact[] =
{
       ...
       0,     0,    19,     0,     0,     0,    14,    15,     1,     0,
       0,     0,     0,     0,     0,    16,     0,     0,     0,     0,
       0,     0,     0,     6,     7,     8,     9,     0,    46,    44,
      45,     0,     0,     0,    26,     0,     0,    13,    20,     0,
       0,     5,     0,     0,    27,    17,    28,    29,    30,    31,
       0,     0,     0,     0,    11,     0,    18,    25,    23,    21,
       0,     0,     0,     0,     0,     0,    43,    41,    42,    40,
       0,    35,     0,     0,     2,     0,    12,     0,    24,    33,
       0,    37,    38,    39,     0,     0,    22,     4,     0,    34,
      36,     0,    32,     3
};
...
{
      25,    52,    38,    39,    40,    53,    54,     1,    26,    12,
       2,    22,     3,     4,    62,     8,    47,     5,    27,     9,
      23,    24,    83,    63,    68,    13,    10,     6,    41,    14,
      18,    42,    84,    56,    57,    58,    59,    11,    19,    88,
      76,    77,    78,    79,   103,    20,    21,    30,    91,    92,
      93,    12,    28,    29,    31,    30,    32,    33,    45,    48,
      34,    35,    49,    64,    36,    61,    69,    37,    51,    55,
      72,    87,    65,    74,    66,    67,    70,    73,    85,    96,
      89,    95,   101,    90,    86,    99,    97,    75,   102,    98,
     100
};

static const yytype_uint8 yycheck[] =
{
      13,    37,     3,     4,     5,    41,    42,     7,    19,     3,
      10,     6,    12,    13,    22,     8,    29,    17,    29,     6,
      15,    16,    18,    31,    60,    19,     8,    27,    29,    23,
       0,    32,    28,    32,    33,    34,    35,    14,     3,    75,
       3,     4,     5,     6,    28,    11,     3,    31,    36,    37,
      38,     3,    21,    31,    29,    31,     3,    28,     3,     3,
      28,    28,     3,     3,    28,    24,     3,    29,    28,    30,
       3,     9,    30,    24,    30,    30,    29,    31,    24,     3,
      30,    20,    95,    26,    73,    90,    28,    67,    98,    25,
      94
};
...
{
       0,     7,    10,    12,    13,    17,    27,    40,     8,     6,
       8,    14,     3,    19,    23,    42,    43,    44,     0,     3,
      11,     3,     6,    15,    16,    44,    19,    29,    21,    31,
      31,    29,     3,    28,    28,    28,    28,    29,     3,     4,
       5,    29,    32,    46,    53,     3,    45,    44,     3,     3,
      41,    28,    46,    46,    46,    30,    32,    33,    34,    35,
      47,    24,    22,    31,     3,    30,    30,    30,    46,     3,
      29,    48,     3,    31,    24,    47,     3,     4,     5,     6,
      49,    50,    52,    18,    28,    24,    41,     9,    46,    30,
      26,    36,    37,    38,    51,    20,     3,    28,    25,    49,
      52,    44,    48,    28
};
...
#line 116 "Parser.y" /* yacc.c:1646  */
    {
    tableName = (yyvsp[-6].actualChars);
    attrList = (yyvsp[-4].myAttrList);
    commandType = 1;
}
...
#line 122 "Parser.y" /* yacc.c:1646  */
    {
    tableFileToLoad = (yyvsp[-3].actualChars);
    tableName = (yyvsp[-1].actualChars);
    commandType = 2;
}
...
#line 133 "Parser.y" /* yacc.c:1646  */
    {
    outputLocation = (yyvsp[-1].actualChars);
    commandType = 4;
}
